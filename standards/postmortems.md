...
Completed post-mortems SHOULD be saved in the [post-morterms directory](../post-morterms/) ([sample](../post-morterms/sample.md)) for a historical record and shared with relevant parties.
